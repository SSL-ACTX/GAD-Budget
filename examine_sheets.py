...
def examine_sheet(filename, sheet_xml, sheet_name):
...
if __name__ == "__main__":
    ...
    examine_sheet(xl_file, "sheet4.xml", "SUMMARY")
    examine_sheet(xl_file, "sheet5.xml", "LBP2-Accounts")
    examine_sheet(xl_file, "sheet6.xml", "LBP4-AIP-Obligated")
